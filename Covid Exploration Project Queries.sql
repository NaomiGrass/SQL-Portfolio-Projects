...
--Shows percentage of population that contracted covid in Finland
...
/*SELECT TOP 10 Location, Population, MAX(total_cases) AS 'Highest Infection Rate', ROUND(MAX((total_cases/population))*100,2) AS 'Highest Infection Rate Percentage'
--FROM [Data Exploration Portfolio Project ]..CovidDeaths
...
/*SELECT TOP 5  Location, MAX(cast(total_deaths as int)) AS 'Total Death Count'
FROM [Data Exploration Portfolio Project ]..CovidDeaths
...
--Looking at Total Population Vs Vaccination to show a Rolling Count of people Vaccinated
...
SELECT *, (RollingCountofVaccinatedPeople/Population)*100 as VaccinatedPercentage
